...
-- CreateTable
CREATE TABLE "OnCampusMeetupAddress" (
    "id" SERIAL NOT NULL,
    "name" TEXT NOT NULL,
    "coordinate" INTEGER[],
    "pictures_urls" TEXT[],
    ...
    CONSTRAINT "OnCampusMeetupAddress_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "OnCampusMeetupAddress" ADD CONSTRAINT "OnCampusMeetupAddress_address_id_fkey" FOREIGN KEY ("address_id") REFERENCES "Address"("id") ON DELETE SET NULL ON UPDATE CASCADE;
